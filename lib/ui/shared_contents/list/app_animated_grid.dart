...
class AppAnimatedGrid extends StatefulWidget {
  ...
  @override
  State<AppAnimatedGrid> createState() => _AppAnimatedGridState();
}

class _AppAnimatedGridState extends State<AppAnimatedGrid> {
